...
\begin{itemize}
    ...
    \item implementar em HDL um núcleo GMP completo de 39 termos, com coeficientes complexos e pipeline para throughput de uma amostra por ciclo;
...
O \texttt{gmp\_engine} implementado nesta etapa é compatível com o modelo OpenDPD de 39 termos. Para reduzir pressão de temporização em SKY130, o núcleo foi dividido em estágios de pipeline. O primeiro estágio monta a janela de amostras, o segundo calcula magnitudes, e os estágios seguintes acumulam grupos de termos do GMP. Com o pipeline cheio e os coeficientes previamente carregados para cache interno, o bloco aceita uma amostra por ciclo. Assim, para uma taxa de 24 MS/s, o objetivo mínimo é fechar temporização acima de 24 MHz. Frequências superiores são desejáveis para margem de integração, mas ainda dependem de síntese e análise física.
...
\begin{itemize}
    ...
    \item operação streaming com uma amostra por ciclo;
