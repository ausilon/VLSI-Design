...
//                       [6]=capture_lock [7]=capture_ready
//                       [8]=train_busy [9]=train_done [10]=train_error
//                       [11]=coef_ready [12]=switch_pending
...
module axi_lite_regs #(
    ...
    output reg  [CAPTURE_ADDR_WIDTH-1:0] train_sample_count,
    ...
    always @(posedge clk or negedge resetn) begin
        if (!resetn) begin
            ...
            train_sample_count    <= {CAPTURE_ADDR_WIDTH{1'b1}};
            feedback_delay        <= 8'd0;
            ...
            if (wr_fire) begin
                ...
                case (s_axi_awaddr[11:0])
                    12'h000: begin
                        ...
                        if (s_axi_wdata[5]) train_start_pulse <= 1'b1;
                    end
                    ...
                    12'h058: train_sample_count <= s_axi_wdata[CAPTURE_ADDR_WIDTH-1:0];
                    default: begin end
                endcase
            ...
            if (rd_fire) begin
                ...
                case (s_axi_araddr[11:0])
                    12'h000: s_axi_rdata <= {26'd0, train_start_pulse, irq_clear_pulse, 1'b0, 1'b0, force_bypass, enable};
                    12'h004: s_axi_rdata <= {19'd0, coef_switch_pending, coef_ready, train_error, train_done,
                                              train_busy, capture_ready, capture_lock, irq, active_bank,
                                              coef_switch_busy, capture_done, capture_busy, dpd_active};
                    ...
                    12'h058: s_axi_rdata <= {{(32-CAPTURE_ADDR_WIDTH){1'b0}}, train_sample_count};
                    12'h05c: s_axi_rdata <= mac_error_acc;
                    12'h060: s_axi_rdata <= 32'd0;
