...
//
// Contains the real-time GMP inference engine and synchronized bypass
// selection. Training is handled outside this fast path in v2.
// ============================================================
module dpd_filter #(
    ...
    gmp_engine #(
        ...
        .reload_coeffs(sync_event),
        .i_in(i_in),
        .q_in(q_in),
        .in_valid(in_valid && use_dpd),
        .in_ready(mac_ready),
        .i_out(mac_i),
        .q_out(mac_q),
        .out_valid(mac_valid),
    ...
    assign in_ready = use_dpd ? mac_ready : out_ready;
